...
export class Bidwatcher__fetchItemsListedResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
...
export class Bidwatcher__fetchMarketItemsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class Bidwatcher__fetchMyNFTsResultValue0Struct extends ethereum.Tuple {
  get tokenId(): BigInt {
    return this[0].toBigInt();
  }
...
export class Bidwatcher extends ethereum.SmartContract {
  static bind(address: Address): Bidwatcher {
    return new Bidwatcher("Bidwatcher", address);
  }
  ...
  fetchItemsListed(): Array<Bidwatcher__fetchItemsListedResultValue0Struct> {
    let result = super.call(
      "fetchItemsListed",
      "fetchItemsListed():((uint256,address,address,uint256,bool)[])",
      []
    );

    return result[0].toTupleArray<
      Bidwatcher__fetchItemsListedResultValue0Struct
    >();
  }

  try_fetchItemsListed(): ethereum.CallResult<
    Array<Bidwatcher__fetchItemsListedResultValue0Struct>
  > {
    ...
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Bidwatcher__fetchItemsListedResultValue0Struct>()
    );
  }

  fetchMarketItems(): Array<Bidwatcher__fetchMarketItemsResultValue0Struct> {
    let result = super.call(
      "fetchMarketItems",
      "fetchMarketItems():((uint256,address,address,uint256,bool)[])",
      []
    );

    return result[0].toTupleArray<
      Bidwatcher__fetchMarketItemsResultValue0Struct
    >();
  }

  try_fetchMarketItems(): ethereum.CallResult<
    Array<Bidwatcher__fetchMarketItemsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMarketItems",
      "fetchMarketItems():((uint256,address,address,uint256,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Bidwatcher__fetchMarketItemsResultValue0Struct>()
    );
  }

  fetchMyNFTs(): Array<Bidwatcher__fetchMyNFTsResultValue0Struct> {
    let result = super.call(
      "fetchMyNFTs",
      "fetchMyNFTs():((uint256,address,address,uint256,bool)[])",
      []
    );

    return result[0].toTupleArray<Bidwatcher__fetchMyNFTsResultValue0Struct>();
  }

  try_fetchMyNFTs(): ethereum.CallResult<
    Array<Bidwatcher__fetchMyNFTsResultValue0Struct>
  > {
    let result = super.tryCall(
      "fetchMyNFTs",
      "fetchMyNFTs():((uint256,address,address,uint256,bool)[])",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      value[0].toTupleArray<Bidwatcher__fetchMyNFTsResultValue0Struct>()
    );
  }
